...
import { Completeaffiliates_campaigns_relations, Relatedaffiliates_campaigns_relationsModel, Completeaffiliates, RelatedaffiliatesModel } from "./index"
...
export interface Completeaffiliates_profiles extends z.infer<typeof affiliates_profilesModel> {
  affiliates_campaigns_relations: Completeaffiliates_campaigns_relations[]
...
export const Relatedaffiliates_profilesModel: z.ZodSchema<Completeaffiliates_profiles> = z.lazy(() => affiliates_profilesModel.extend({
  affiliates_campaigns_relations: Relatedaffiliates_campaigns_relationsModel.array(),
