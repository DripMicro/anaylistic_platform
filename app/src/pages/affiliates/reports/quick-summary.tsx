										...
										{Object.keys(data!).map((item, key) => {
											...
											return (
												<Tr>
													...
													<Td>
														{quick_summary?.Volume?.toFixed(
															2
														)}
													</Td>
													<Td>
														{quick_summary?.Withdrawal?.toFixed(
															2
														)}
													</Td>
													<Td>
														{
															quick_summary?.ChargeBack
														}
													</Td>
													<Td>
														{
															quick_summary?.ActiveTrader
														}
													</Td>
													<Td>
														{quick_summary?.Commission?.toFixed(
															2
														)}
													</Td>
												</Tr>
