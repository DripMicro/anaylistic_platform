...
export interface Completepixel_monitor
  extends z.infer<typeof pixel_monitorModel> {
 ...
 */
export const Relatedpixel_monitorModel: z.ZodSchema<Completepixel_monitor> =
  z.lazy(() =>
