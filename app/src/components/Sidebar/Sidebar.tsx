...
export default function Sidebar({ collapseShow }: Props) {
  ...
  return (
    <>
      <div
        className= {
          (collapseShow ? "w-64 rounded-tr-[50px] md:rounded-none " : "md:w-32 w-0 ") +
            ...
            <li>
              ...
              >
                <img
                  ...
                  src={"/img/icons/marketing" + (dropdown == "marketing" ? "Active" : "") + ".png"}
                />
                {collapseShow ? <span className={"ml-4 text-base font-medium tracking-wide truncate " + (dropdown == "marketing" ? "text-[#2262C6]" : "")}>Marketing Tools</span> : ""}
                <span className="py-0.5 ml-auto mr-8 text-xs font-medium tracking-wide truncate">
                  <img
                    alt="..."
                    className={"align-middle border-none" + (dropdown == "marketing" ? " w-3" : " w-2 ")}
                    src={"/img/icons/Vector" + (dropdown == "marketing" ? "1" : "") + ".png"}
                  />
                </span>
              </div>
              <ul 
                className={"flex-col pt-2 " + (dropdown == "marketing" && collapseShow ? "flex" : "hidden")}
              >
                <li>
                  <div 
                  ...
                  >
                    {collapseShow ? <span className={"ml-4 text-base font-medium tracking-wide truncate " + (activeName == "creative" ? "text-[#2262C6]" : "")}>Creative Materials</span> : ""}
                  </div>
                </li>
                <li>
                  <div 
                  ...
                  >
                    {collapseShow ? <span className={"ml-4 text-base font-medium tracking-wide truncate " + (activeName == "sub" ? "text-[#2262C6]" : "")}>Sub Affliate Creatives</span> : ""}
                  </div>
                </li>
              </ul>
            </li>
              ...
              <Link as={NextLink} href="/affiliates/signin">
                ...
                >
                  <img
                    alt="..."
                    className="w-6 align-middle border-none pt-0.5"
                    src={"/img/icons/dashboard" + (activeName == "dashboard" ? "Active" : "") + ".png"}
                  />
                  {collapseShow ? <span className={"ml-4 text-base font-medium tracking-wide truncate " + (activeName == "dashboard" ? "text-[#2262C6]" : "")}>Dashboard</span> : ""}
                </div>
              </Link>
            </li>
          </ul>
