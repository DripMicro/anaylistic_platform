...
export interface Completemerchants_creative_categories
  extends z.infer<typeof merchants_creative_categoriesModel> {
 ...
 */
export const Relatedmerchants_creative_categoriesModel: z.ZodSchema<Completemerchants_creative_categories> =
  z.lazy(() =>
    merchants_creative_categoriesModel.extend({
