...
export interface Completestats_banners
  extends z.infer<typeof stats_bannersModel> {
 ...
 */
export const Relatedstats_bannersModel: z.ZodSchema<Completestats_banners> =
  z.lazy(() =>
    stats_bannersModel.extend({
