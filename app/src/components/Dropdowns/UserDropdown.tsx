        ...
        <div className="text-sm py-2 px-4 font-normal w-full whitespace-nowrap bg-transparent flex">
          <span className="items-center justify-center inline-flex">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
              <path d="M10.6668 8.66659V7.33325H4.66683V5.33325L1.3335 7.99992L4.66683 10.6666V8.66659H10.6668Z" fill="#404040"/>
              <path d="M13.3333 2H7.33333C6.598 2 6 2.598 6 3.33333V6H7.33333V3.33333H13.3333V12.6667H7.33333V10H6V12.6667C6 13.402 6.598 14 7.33333 14H13.3333C14.0687 14 14.6667 13.402 14.6667 12.6667V3.33333C14.6667 2.598 14.0687 2 13.3333 2Z" fill="#404040"/>
            </svg>
          </span>
          <span className="pl-2">
            Log Out
