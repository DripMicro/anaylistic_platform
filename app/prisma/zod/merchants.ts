...
import {
  ...
  RelatedapicredentialsModel,
  Completecron_logs,
  Relatedcron_logsModel,
 ...
 */
export const RelatedmerchantsModel: z.ZodSchema<Completemerchants> = z.lazy(
  () =>
    merchantsModel.extend({
      ...
      merchants_creative_categories:
        Relatedmerchants_creative_categoriesModel.array(),
